 ...
 */
public class SpecialPlan2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		from.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				new DatePickerDialog(SpecialPlan2.this, d, dateAndTime
			...
			public void onClick(View v) {
				...
				if (!(fyear.endsWith("Year") || fmonth.endsWith("Month")
					...
					if (VerifyDate()) {
						...
						sptask = new SpecialAsyncTask(SpecialPlan2.this,
								jsObject, list,3);
						sptask.execute(MyApplication.setUrl("viewmissionprocess"));

					} else if (!VerifyDate()) {
						Toast.makeText(SpecialPlan2.this, "Time setting Wrong",
								Toast.LENGTH_SHORT).show();
					} else {
						Toast.makeText(SpecialPlan2.this, "Wrong Operation!",
								Toast.LENGTH_SHORT).show();
					}

				} else {
					Toast.makeText(SpecialPlan2.this,
	...
	/*DatePickerDialog.OnDateSetListener d = new DatePickerDialog.OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int year, int monthOfYear,
			...
			if (INDEX == 1) {
				...
				Toast.makeText(SpecialPlan2.this, "please select the full date",
						Toast.LENGTH_SHORT).show();
			}
	...
	private void init() {
		...
		df = new DialogForMe(SpecialPlan2.this);
		...
		stms = new SetTy_MoforSpinner(SpecialPlan2.this, ty, mod);
	}
