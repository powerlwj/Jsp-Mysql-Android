...
public class ProcessofSpSForOD_AM extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		from.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				new DatePickerDialog(ProcessofSpSForOD_AM.this, d, dateAndTime
...
shsp.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				salert=new SpecialAlertAsyncTask(ProcessofSpSForOD_AM.this, params);
				salert.execute(MyApplication.setUrl("specialplanalert"));
				} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
				}
				 /*AlertDialog.Builder builder = new AlertDialog.Builder(ProcessofSpSForOD_AM.this);
	                builder.setTitle("Special Target");
	                //    通过LayoutInflater来加载一个xml的布局文件作为一个View对象
	                View view = LayoutInflater.from(ProcessofSpSForOD_AM.this).inflate(R.layout.shsp, null);
			...
			public void onClick(View arg0) {
				...
				//		|| tmonth.endsWith("Month") || tday.endsWith("Day"))) {
					if (VerifyDate()) {
						...
						sptask = new SpecialAsyncTask(ProcessofSpSForOD_AM.this,
								jsObject, list,3);
						sptask.execute(MyApplication.setUrl("process_special"));

					} else if (!VerifyDate()) {
						Toast.makeText(ProcessofSpSForOD_AM.this, "Time setting Wrong",
								Toast.LENGTH_SHORT).show();
					} else {
						Toast.makeText(ProcessofSpSForOD_AM.this, "Wrong Operation!",
								Toast.LENGTH_SHORT).show();
					}

				} else {
					Toast.makeText(ProcessofSpSForOD_AM.this,
...
//		shsp.setVisibility(View.GONE);
		...
		df = new DialogForMe(ProcessofSpSForOD_AM.this);
		...
		stms = new SetTy_MoforSpinner(ProcessofSpSForOD_AM.this, ty, mod);
	}
	...
	DatePickerDialog.OnDateSetListener d = new DatePickerDialog.OnDateSetListener() 
	{
		...
		public void onDateSet(DatePicker view, int year, int monthOfYear,
			...
			{
				Toast.makeText(ProcessofSpSForOD_AM.this, "please select the full date",
						Toast.LENGTH_SHORT).show();
			}
