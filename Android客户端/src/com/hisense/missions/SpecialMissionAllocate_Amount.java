 ...
 *类说明：二级经理的任务分配
 */
public class SpecialMissionAllocate_Amount extends Activity {
	...
	private String targetAmount, target;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		from.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				new DatePickerDialog(SpecialMissionAllocate_Amount.this, d, dateAndTime
...
//								jsObject.put("price", price);
								...
								aloc.post(SpecialMissionAllocate_Amount.this, MyApplication.setUrl("specialmissionalocate"), s, HTTP.UTF_8, new AsyncHttpResponseHandler() 
								{
									...
									public void onSuccess(int arg0, Header[] arg1, byte[] arg2) 
									{
										...
										if(arg0==200)
										{
											...
											if(index)
											{
												Toast.makeText(SpecialMissionAllocate_Amount.this, "Target for "+mystuff+" is successful", Toast.LENGTH_SHORT).show();
												num.setText("");
												p1.setText("");
												p2.setText("");
											}
											...
											{
												Toast.makeText(SpecialMissionAllocate_Amount.this, "Target for "+mystuff+" is failed", Toast.LENGTH_SHORT).show();
											}
										}
									}
									...
									{
										// TODO Auto-generated method stub
										Toast.makeText(SpecialMissionAllocate_Amount.this, "Unknown Error", Toast.LENGTH_SHORT).show();
									}
								});
							} 
						...
						{
							Toast.makeText(SpecialMissionAllocate_Amount.this,MyApplication.totalinfo, Toast.LENGTH_SHORT).show();
						}
					}
					else if (!VerifyDate()) 
					{
						Toast.makeText(SpecialMissionAllocate_Amount.this, "Time setting Wrong", Toast.LENGTH_SHORT).show();
					} 
					else 
					{
						Toast.makeText(SpecialMissionAllocate_Amount.this, "Wrong Operation!", Toast.LENGTH_SHORT).show();
					}
				} 
				else
				{
					Toast.makeText(SpecialMissionAllocate_Amount.this, "Please Enter a clear period of time", Toast.LENGTH_SHORT).show();
				}
	...
	private void init() {
		...
		df=new DialogForMe(SpecialMissionAllocate_Amount.this);
		...
		stms = new SetTy_MoforSpinner(SpecialMissionAllocate_Amount.this, ty, mod);
		noc=new NumORChars();
	}
	...
	private void GetStuffList() {
		// TODO Auto-generated method stub
			...
			try {
				...
				st.post(SpecialMissionAllocate_Amount.this, MyApplication.setUrl("stuff"), s, HTTP.UTF_8,  new AsyncHttpResponseHandler()
				 {
...
//								Toast.LENGTH_SHORT).show();
						...
						try {
							...
							ArrayAdapter<String> ty_adaptAdapter = new ArrayAdapter<String>(
									SpecialMissionAllocate_Amount.this, android.R.layout.select_dialog_item,
									stuffs);
					...
					public void onFailure(int arg0, Header[] arg1, byte[] arg2,
						...
						Toast.makeText(SpecialMissionAllocate_Amount.this, MyApplication.serverwrong,
								Toast.LENGTH_SHORT).show();
					}
				});
	...
	/*DatePickerDialog.OnDateSetListener d = new DatePickerDialog.OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int year, int monthOfYear,
			...
			if (INDEX == 1) {
				...
				Toast.makeText(SpecialMissionAllocate_Amount.this, "please select the full date",
						Toast.LENGTH_SHORT).show();
			}
