...
public class ProcessofMS_TP extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				new DatePickerDialog(ProcessofMS_TP.this, d, dateAndTime
		...
		refresh.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (!(yearname.endsWith("Year") || monthname.endsWith("Month"))) 
				{
					...
					vmtask=new ViewMissionsTask(ProcessofMS_TP.this, plist, jsObject,3);
					vmtask.execute(MyApplication.setUrl("process_ms"));
				}
				else 
				{
					Toast.makeText(ProcessofMS_TP.this, "Please choose a peroid of time!", 1).show();
				}
	...
	private void initview() {
		...
		stms = new SetTy_MoforSpinner(ProcessofMS_TP.this, ty, mod);
