...
public class ProcessofSpS_TP extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		from.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				new DatePickerDialog(ProcessofSpS_TP.this, d, dateAndTime
			...
			public void onClick(View arg0) {
				...
				if(!(fd.equals("null-null-null")||td.equals("null-null-null"))){
					if (VerifyDate()) {
						...
						sptask = new SpecialAsyncTask(ProcessofSpS_TP.this,
								jsObject, list,3);
						sptask.execute(MyApplication.setUrl("process_special"));

					} else if (!VerifyDate()) {
						Toast.makeText(ProcessofSpS_TP.this, "Time setting Wrong",
								Toast.LENGTH_SHORT).show();
					} else {
						Toast.makeText(ProcessofSpS_TP.this, "Wrong Operation!",
								Toast.LENGTH_SHORT).show();
					}

				} else {
					Toast.makeText(ProcessofSpS_TP.this,
	...
	private void initview() {
		...
		df = new DialogForMe(ProcessofSpS_TP.this);
		...
		stms = new SetTy_MoforSpinner(ProcessofSpS_TP.this, ty, mod);
	}
	...
	/*DatePickerDialog.OnDateSetListener d = new DatePickerDialog.OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int year, int monthOfYear,
			...
			if (INDEX == 1) {
				...
				Toast.makeText(ProcessofSpS_TP.this, "please select the full date",
						Toast.LENGTH_SHORT).show();
			}
