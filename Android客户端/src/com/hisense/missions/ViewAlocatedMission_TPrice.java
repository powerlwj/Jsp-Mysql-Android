...
public class ViewAlocatedMission_TPrice extends Activity{
	...
	ListView missions;
	public String date1;
	public static ListView upmission2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("View Allocated Monthly Targets");
		setContentView(R.layout.viewmonthmission_tp);
		//界面初始化
		init();
		//获取二级经理的员工
		GetStuffList();
		setdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				new DatePickerDialog(ViewAlocatedMission_TPrice.this, d, dateAndTime
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!(targetTime.equals("null-null")))
				{
					...
					vmtask=new ViewMissionsTask(ViewAlocatedMission_TPrice.this, missions, jsObject,2);
					...
					missions.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View arg1,
							...
							MyApplication.MONTH_INDEX=2;
							String type = map.get("type");
							String model = map.get("model");
							String targetAmount = map.get("targetAmount");
							String target = map.get("target");
							Intent ed = new Intent(ViewAlocatedMission_TPrice.this,
				...
				{
					Toast.makeText(ViewAlocatedMission_TPrice.this, "Please choose a peroid of time!", 1).show();
				}
	...
	private void init() {
		// TODO Auto-generated method stub
		df=new DialogForMe(ViewAlocatedMission_TPrice.this);
		...
		upmission2=(ListView)findViewById(R.id.missions);
	...
	private void GetStuffList() {
		// TODO Auto-generated method stub
			...
			try {
				...
				st.post(ViewAlocatedMission_TPrice.this, MyApplication.setUrl("stuff"), s, HTTP.UTF_8,  new AsyncHttpResponseHandler()
				 {
...
//								Toast.LENGTH_SHORT).show();
						...
						try {
							...
							ArrayAdapter<String> ty_adaptAdapter = new ArrayAdapter<String>(
									ViewAlocatedMission_TPrice.this, android.R.layout.select_dialog_item,
									stuffs);
					...
					public void onFailure(int arg0, Header[] arg1, byte[] arg2,
						...
						Toast.makeText(ViewAlocatedMission_TPrice.this, MyApplication.serverwrong,
								Toast.LENGTH_SHORT).show();
					}
				});
