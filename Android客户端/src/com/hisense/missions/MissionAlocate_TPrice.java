 ...
 *类说明：二级经理的任务分配
 */
public class MissionAlocate_TPrice extends Activity {

	private Spinner ty, mod, stuff;
	private EditText p1, p2, num;
	private Button alocate;
	private String marketPrice, price, target;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		alocate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				//marketPrice=p1.getText().toString();
				price=p2.getText().toString();
				target=num.getText().toString();
				if(!("".equalsIgnoreCase(price)&&"".equalsIgnoreCase(target)))
				{
...
//					jsObject.put("model", MyAsyncTask.salemodel);
					...
					jsObject.put("targetAmount", price);
					//jsObject.put("marketPrice", marketPrice);
					jsObject.put("target", target);
					StringEntity s=new StringEntity(jsObject.toString());
					
					aloc.post(MissionAlocate_TPrice.this, MyApplication.setUrl("missionalocate"), s, HTTP.UTF_8, new AsyncHttpResponseHandler() {
						...
						public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
							...
							if(arg0==200)
							{
								...
								if(index)
								{
									Toast.makeText(MissionAlocate_TPrice.this, "Target for "+mystuff+" is successful", Toast.LENGTH_SHORT).show();
									p2.setText("");num.setText("");
								}else
								{
									Toast.makeText(MissionAlocate_TPrice.this, "Target for"+mystuff+"is failed", Toast.LENGTH_SHORT).show();
								}
							}
						}
						...
						public void onFailure(int arg0, Header[] arg1, byte[] arg2, Throwable arg3) {
							// TODO Auto-generated method stub
							Toast.makeText(MissionAlocate_TPrice.this, "Unknown Error", Toast.LENGTH_SHORT).show();
						}
					});
			...
			{
				Toast.makeText(MissionAlocate_TPrice.this,MyApplication.totalinfo, Toast.LENGTH_SHORT).show();
			}
			}
		});
	}
	...
	private void init() {
		// TODO Auto-generated method stub
		df=new DialogForMe(MissionAlocate_TPrice.this);
		...
		stms = new SetTy_MoforSpinner(MissionAlocate_TPrice.this, ty, mod);
		noc=new NumORChars();
	}
	...
	private void GetStuffList() {
		// TODO Auto-generated method stub
			...
			try {
				...
				st.post(MissionAlocate_TPrice.this, MyApplication.setUrl("stuff"), s, HTTP.UTF_8,  new AsyncHttpResponseHandler()
				 {
...
//								Toast.LENGTH_SHORT).show();
						...
						try {
							...
							ArrayAdapter<String> ty_adaptAdapter = new ArrayAdapter<String>(
									MissionAlocate_TPrice.this, android.R.layout.select_dialog_item,
									stuffs);
					...
					public void onFailure(int arg0, Header[] arg1, byte[] arg2,
						...
						Toast.makeText(MissionAlocate_TPrice.this, MyApplication.serverwrong,
								Toast.LENGTH_SHORT).show();
					}
				});
