...
public class Target {
	...
	public Target(String model, int achieved, String type,
			...
			String targetTime2, String totalPrice, int index, int target,
			int targetAmount) {
		super();
		this.model = model;
	...
	public String toString() {
		return "Target [model=" + model + ", target=" + target + ", targetAmount=" + targetAmount + ",achieved="
				+ achieved + ", type=" + type + ", month=" + month + ", price="
				+ price + ", marketPrice=" + marketPrice + ", ownerID="
				+ ownerID + ", remain=" + remain + ", targetType=" + targetType
				+ ", targetTime=" + targetTime + ", targetTime2=" + targetTime2
				+ "]";
	}
